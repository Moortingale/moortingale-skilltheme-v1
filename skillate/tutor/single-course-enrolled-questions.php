    ...
    <div <?php tutor_post_class('tutor-question-answare-wrap tutor-page-wrap'); ?>>
        ...
        <div class="container course-single-attribute">
            <div class="row align-items-lg-center">
                ...
                <?php if(!empty(get_tutor_course_duration_context())){ ?>
                <div class="col-lg-2 col-4 mb-sm-0 mb-1">
                    <div class="course-attribute-single">
                        <span><?php echo esc_html__('Total Hour', 'skillate'); ?></span>
                        <h3><?php echo esc_html(get_tutor_course_duration_context()); ?></h3>
                    </div>
                </div>
                <?php } ?>
                    ...
                    <div class="tutor-course-status">
                        ...
                        <div class="tutor-progress-bar-wrap">
                            <div class="tutor-progress-bar">
                                <div class="tutor-progress-filled" style="--tutor-progress-left: <?php echo esc_html($completed_count).'%;'; ?>"></div>
                            </div>
                            <span class="tutor-progress-percent"><?php echo esc_html($completed_count); ?>% <?php esc_attr_e(' Complete', 'skillate')?></span>
                        </div>
                    </div>
