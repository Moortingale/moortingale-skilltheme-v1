...
if(!function_exists('skillate_style')):
    ...
    function skillate_style(){
        ...
        wp_enqueue_script('skillate-main',SKILLATE_JS.'main.js',array(),false,true);

        // For Ajax URL
        global $wp;
        wp_localize_script( 'skillate-main', 'ajax_object', array(
    ...
    function skillate_plugins_include()
    {
        $plugins = array(
                ...
                array(
                    ...
                    'slug'                  => 'skillate-core',
                    'source'                => 'https://demo.themeum.com/wordpress/plugins/skillate/skillate-core.zip',
                    'required'              => true,
                    'version'               => '',
                    'force_activation'      => false,
                    'force_deactivation'    => false,
                ...
                array(
                    ...
                    'source'                => 'https://demo.themeum.com/wordpress/plugins/skillate/skillate-demo-importer.zip',
                    'required'              => false,
                    'version'               => '',
                    'force_activation'      => false,
                    'force_deactivation'    => false,
