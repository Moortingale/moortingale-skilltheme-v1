...
if(!function_exists('skillate_css_generator')){
    function skillate_css_generator(){
        ...
        if( $preset ){
            if( get_theme_mod( 'custom_preset_en', true ) ) {
                ...
                if($major_color){
                    ...
                    .tutor-course-lesson h5 a:hover { color: '. esc_attr($major_color) .'; }';
                }
                ...
                if($major_color){
                    $output .= '
                    span.tutor-text-avatar{ background: '. esc_attr($major_color) .'!important; }
                    ';
                }
        ...
        $output .= 'input[type=submit],input[type="button"].wpneo-image-upload,
                    .btn.btn-border-skillate:hover,.btn.btn-border-white:hover{ background-color: '.esc_attr( get_theme_mod( 'button_bg_color', '#ff5248' ) ) .'; border-color: '.esc_attr( get_theme_mod( 'button_bg_color', '#ff5248' ) ) .'; color: '.esc_attr( get_theme_mod( 'button_text_color', '#fff' ) ) .' !important; border-radius: '.esc_attr(get_theme_mod( 'button_radius', 4 )).'px; }';
        $output .= '.skillate-login-register a.skillate-dashboard, .skillate-widgets span.blog-cat:before{ background-color: '.esc_attr( get_theme_mod( 'button_bg_color', '#ff5248' ) ) .'; }';

        // Background hover color
        if ( get_theme_mod( 'button_hover_bg_color', '#1f2949' ) ) {
            $output .= 'input[type=submit]:hover { background-color: '.esc_attr( get_theme_mod( 'button_hover_bg_color', '#1f2949' ) ) .'; border-color: '.esc_attr( get_theme_mod( 'button_hover_bg_color', '#1f2949' ) ) .'; color: '.esc_attr( get_theme_mod( 'button_hover_text_color', '#fff' ) ) .' !important; }';
        }
        ...
        if(get_theme_mod('splash_bg', get_template_directory_uri().'/images/mobile-screen-bg.png')){
            $output .= '.skillate-splash-screen{ background:url('.get_theme_mod('splash_bg', get_template_directory_uri().'/images/mobile-screen-bg.png').'); background-color: #fff; }';
        }else{
        ...
        $output .= '#bottom-wrap a:hover{ color: '.esc_attr( get_theme_mod( 'bottom_hover_color', '#ff5248' ) ) .'; }';
