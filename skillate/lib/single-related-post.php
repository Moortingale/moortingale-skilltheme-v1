<?php 
    ...
    $output .= '<div class="skillate-related-course">';
        $output .= '<div class="container">';
            $output .= '<h3 class="course-related-title">'.__('More Courses to get <b>You Started</b>','skillate').'</h3>';
        $output .= '</div>';
        $output .= '<div dir="rtl" class="skillate-related-course-items skillate-related-course-slide">';
