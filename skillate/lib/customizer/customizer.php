...
$skillate_panel_to_section = array(
	...
	'sections'     => array(
		...
		array(
            ...
            'title'           => esc_html__( 'Course Page Settings', 'skillate' ),
            ...
            'fields'         => array(
				...
				array(
                    ...
                    'label'    => esc_html__( 'Top & Bottom Slide Count', 'skillate' ),
                    'type'     => 'number',
                    'priority' => 10,
                    'default'  => 6
				),
				...
				array(
                    ...
                    'label'    => esc_html__( 'Sidebar filter Enable', 'skillate' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
                ...
                array(
                    ...
                    'label'    => esc_html__( 'Enable Course Sorting Bar', 'skillate' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
                array(
                    ...
                    'label'    => esc_html__( 'New Tag Count', 'skillate' ),
                    'type'     => 'number',
                    'priority' => 10,
                    'default'  => 5
                ),
                array(
                    ...
                    'label'    => esc_html__( 'Enable Course Per Page', 'skillate' ),
                    'type'     => 'number',
                    'priority' => 10,
                    'default'  => 9
                ),
                array(
                    ...
                    'label'    => esc_html__( 'Enable Course Pagination', 'skillate' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
                array(
                    ...
                    'label'    => esc_html__( 'Enable Instrcutor Slide', 'skillate' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
...
$skillate_framework = new THM_Customize( $skillate_panel_to_section );
