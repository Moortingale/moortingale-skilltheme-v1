...
<div class="skillate-instructor-slide-wrap">
    <div class="container">
        <h3 class="course-related-title d-inline-block">
            <?php echo __('Most favourite <b>Instructor.</b>', 'skillate'); ?>
        </h3>
        <a class="view-more-link" href="<?php echo $instructor_page_link; ?>">
            <?php echo esc_html__('View More', 'skillate'); ?>
        </a>
    </div>

    <div dir="rtl" class="skillate-related-course-slide">
        <?php 
