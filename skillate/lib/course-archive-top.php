<?php 
    ...
    $course_slide_count = get_theme_mod('top_bottom_slide_count', 6);
    ...
    if(count($featured_posts) > 0){
        $output .= '<div class="skillate-related-course course-archive-top-slide-wrap">';
            $output .= '<div class="container">';
                $output .= '<h3 class="course-related-title">'.__('Courses to get <b>You Started</b>','skillate').'</h3>';
            $output .= '</div>';
            $output .= '<div dir="rtl" data-slidemode="'.esc_attr($slide_center_mod).'" data-columns="'.esc_attr($course_slide_count).'" class="skillate-related-course-items skillate-related-course-slide '.esc_attr($slide_opacity_en).'">';
                foreach ($featured_posts as $featured_post){ 
                    ...
                    //$src = wp_get_attachment_image_src(get_post_thumbnail_id($featured_post->ID), 'skillate-medium');
