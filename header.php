							...
							<div class="row align-items-center">
								...
								<?php }?>
									...
									<div class="col-md-auto <?php echo esc_attr($en_search_class);?> col-auto header-login-cart-wrap">
										...
										if(get_theme_mod('en_header_shopping_cart', true) && !is_cart() && !is_checkout()){ ?>
														...
														<?php
															if(function_exists('tutor_utils')) {
																...
																foreach ($dashboard_pages as $dashboard_key => $dashboard_page){
																	...
																	echo "<li><a href='".esc_url(tutor_utils()->get_tutor_dashboard_page_permalink($dashboard_key, esc_attr($dashboard_page_id)))."'>".esc_html($menu_title)." </a> </li>";
																}
															}
														?>
													</ul>
